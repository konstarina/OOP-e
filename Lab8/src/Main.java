...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("Simple Division Calculator");
    ...
    private static class UnluckyException extends Throwable {
        private final String s;

        UnluckyException(String s) {
            this.s = s;
            s = "Don't divide by 13. Satan will take your soul";
        }
    }
}